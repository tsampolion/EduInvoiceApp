...
class TestStudentBuilder {
    ...
    private var rateType: String = RateTypes.HOURLY
    ...
    fun withRateType(rateType: String): TestStudentBuilder {
    ...
    fun withLastModified(lastModified: Long): TestStudentBuilder {
