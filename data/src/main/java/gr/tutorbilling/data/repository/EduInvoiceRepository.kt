package gr.tutorbilling.data.repository
...
/**
 * EduInvoiceRepository is the single source of truth for all data operations.
 *
...
class EduInvoiceRepository @Inject constructor(
    ...
    private val groupDao: gr.tutorbilling.data.dao.GroupDao
) {
