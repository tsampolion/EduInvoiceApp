...
import gr.tutorbilling.domain.lesson.GetAllLessons
import gr.tutorbilling.domain.lesson.DeleteLesson
import gr.tutorbilling.domain.lesson.GetLessonById
import gr.tutorbilling.domain.lesson.GetStudentLessons
import gr.tutorbilling.domain.lesson.GetLessonsWithStudents
import gr.tutorbilling.domain.lesson.GetLessonsWithStudentsByStudentAndDateRange
import gr.tutorbilling.domain.lesson.AddLesson
import gr.tutorbilling.domain.lesson.AddGroupLesson
import gr.tutorbilling.domain.lesson.LessonUseCases
import gr.tutorbilling.domain.lesson.UpdateLesson
import gr.tutorbilling.domain.lesson.UpdateLessonPaidStatus
import gr.tutorbilling.domain.lesson.UpdateLessonInvoicedStatus
import gr.tutorbilling.domain.lesson.IsLessonInvoiced
import gr.tutorbilling.data.repository.EduInvoiceRepository
import gr.tutorbilling.domain.student.StudentUseCases
import gr.tutorbilling.domain.student.GetActiveStudents
import gr.tutorbilling.domain.student.GetArchivedStudents
import gr.tutorbilling.domain.student.GetStudentById
import gr.tutorbilling.domain.student.InsertStudent
import gr.tutorbilling.domain.student.UpdateStudent
import gr.tutorbilling.domain.student.SoftDeleteStudent
import gr.tutorbilling.domain.student.RestoreStudent
import gr.tutorbilling.domain.student.GetActiveStudentCount
import gr.tutorbilling.domain.student.ClassNameExists
...
class RevenueViewModelTest {
    ...
    private val tutorBillingRepository = EduInvoiceRepository(studentDao, lessonDao, groupDao)
