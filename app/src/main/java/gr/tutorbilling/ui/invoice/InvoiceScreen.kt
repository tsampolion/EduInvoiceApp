...
import gr.tutorbilling.ui.components.ClickableReadOnlyField
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
private fun StudentDropdown(students: List<gr.tutorbilling.data.model.Student>, selectedId: Long?, onSelect: (Long) -> Unit) {
